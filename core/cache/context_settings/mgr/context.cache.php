...
switch ($modx->event->name) {
    ...
    array (
      ...
      'property_preprocess' => '0',
      'name' => 'ContextRouter',
      'description' => 'ContextRouter is a simple plug-and-play plugin allowing you to use different contexts, and, based on the http_host context settings you need to set anyway, it routes your front-end requests a',
      'editor_type' => '0',
      'category' => '0',
      'cache_type' => '0',
      'plugincode' => '/* @var modX $modx
