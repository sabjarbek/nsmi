<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Britaniya kompaniyasi 15 dollarlik mikrokompyuterni namoyish qildi',
    'longtitle' => 'Britaniya kompaniyasi 15 dollarlik mikrokompyuterni namoyish qildi',
    'description' => '',
    'alias' => 'mikrokompyuter',
    'alias_visible' => 0,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
...
<div class="single-content" style="box-sizing: border-box; outline: none; line-height: 31px; padding: 0px 20px 20px; border-left: 1px solid rgba(151, 151, 151, 0.23); margin-bottom: 20px; position: relative; font-weight: 300;">
<div class="main-img" style="box-sizing: border-box; outline: none; width: 787px; margin-bottom: 10px;"><img style="box-sizing: border-box; outline: none; border: 0px; max-width: 100%; height: auto; margin: auto; display: block; width: 787px;" src="https://storage.kun.uz/source/7/9oeVS8gSWpFT2WpCiJ_-fdRn_w81uQ_0.jpg" alt="" />
<div class="main-img__caption" style="box-sizing: border-box; outline: none; opacity: 0.56; color: #222222; font-family: Montserrat; font-size: 12px; line-height: 16px; letter-spacing: -0.06px; padding-bottom: 10px; padding-top: 10px;">Foto: Raspberry</div>
</div>
<p style="box-sizing: border-box; outline: none;">Mikrokompyuterlar ishlab chiqaruvchi Raspberry Pi Foundation britan kompaniyasi bir platali Raspberry Pi Zero 2 W kompyuterini namoyish qildi. E\'tiborlisi, yangi kompyuter bor-yo‘g‘i 15 dollar <a style="box-sizing: border-box; outline: none; background: 0px 0px; display: inline-block; cursor: pointer; text-decoration-line: none; transition: all 0.3s ease 0s; color: #007bff;" href="https://iz.ru/1242855/2021-10-29/raspberry-prezentovala-kompiuter-za-1-tys-rublei" target="_blank">turadi</a>.</p>
<p style="box-sizing: border-box; outline: none;">Raspberry Pi Zero 2 W’ning 2015 yilda chiqarilgan avvalgi modelga nisbatan ko‘rsatkichlari ancha yaxshilangan. Jumladan, yangi modelning unumdorligi 5 marta oshgan.</p>
<p style="box-sizing: border-box; outline: none;">Mikrokompyuter 64 bitli 4 yadroli Broadcom BCM2710A1 protsessorida ishlaydi. Shuningdek, qurilma LPDDR2 standartidagi 512 Mb tezkor xotira, mini-HDMI, USB, microUSB razyomlari bilan jihozlangan. Bundan tashqari, u Bluetooth 4.2 va Wi-Fi 802.11n simsiz aloqa standartlarini qo‘llab-quvvatlaydi.</p>
<p style="box-sizing: border-box; outline: none;">Kompaniya kompyuter ishlash jarayonida qizib ketmasligiga va\'da bermoqda. Undagi mis qatlamidan tayyorlangan radiator plataning sovishini ta\'minlaydi.</p>
<p style="box-sizing: border-box; outline: none;">Mikrokompyuterga kompaniya saytida buyurtma berish mumkin. Uning bazaviy versiyasi narxi 15 dollar turadi.</p>
</div>',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 0,
...
<html lang="ru">
<head>
    <title>Britaniya kompaniyasi 15 dollarlik mikrokompyuterni namoyish qildi - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">Britaniya kompaniyasi 15 dollarlik mikrokompyuterni namoyish qildi</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>Britaniya kompaniyasi 15 dollarlik mikrokompyuterni namoyish qildi</h1>
                                <p>
