<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'XALQARO HAMKORLIK ALOQALARI KENGAYMOQDA',
    'longtitle' => '',
    'description' => '',
    'alias' => 'xalqaro-hamkorlik-aloqalari',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'content' => '<p>Navoiy davlat konchilik institutida xorijiy universitetlar bilan hamkorlik aloqalarini o‘rnatish va rivojlantirish doirasida navbatdagi xalqaro seminar bo‘lib o‘tdi. Tadbirda institut professor<strong>-</strong>o‘qituvchilari, talabalari, Germaniyaning Freyburg universiteti professori va talabalari, shuningdek NavDKI qoshidagi 2<strong>-</strong>sonli litsey hamda Navoiy davlat pedagogika instituti vakillari  ishtirok etdi.</p>
<p>O‘zbek, nemis va ingliz tillarida olib borilgan mazkur seminar ishtirok etgan talabalar va professor<strong>-</strong>o‘qituvchilar Evropa ta’lim tizimidagi ijobiy o‘zgarishlar haqida kengroq ma’lumotga ega bo‘lishdi.</p>
<p>Frayburg universiteti professori Mirzoxid Rahmonov universitetdagi akademik va  haqida batafsil ma’lumot berdi.</p>
<div>Seminarda Frayburg universiteti talabalari Eliza Golks va Dilnoza Ubaydullaevalar universitetdagi ta’lim tizimi, o‘qish jarayoni va o‘qishdan tashqari faoliyat haqida ma’ruza qilishdi. Tadbir savol<strong>-</strong>javoblarga boy, ishtirokchilarning qizg‘in munozaralari doirasida o‘tdi.</div>',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 0,
    'searchable' => 1,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'xalqaro-hamkorlik-aloqalari.html',
    'uri_override' => 0,
...
<html lang="ru">
<head>
    <title>XALQARO HAMKORLIK ALOQALARI KENGAYMOQDA - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">XALQARO HAMKORLIK ALOQALARI KENGAYMOQDA</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>XALQARO HAMKORLIK ALOQALARI KENGAYMOQDA</h1>
                                <p>
                                   <!--<img class="detail-photo" src="images/news4.jpg"> -->
