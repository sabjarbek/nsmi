<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'МТ',
    'longtitle' => 'Avtomatlashtirish va boshqaruv',
    'description' => '',
    'alias' => 'mt',
    'alias_visible' => 1,
    'link_attributes' => '',
...
<html lang="ru">
<head>
    <title>МТ - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">МТ</li></ol>
                                </nav>
                            </div>
<div class="col-ms-12 detail-content">
    <h1>Avtomatlashtirish va boshqaruv</h1>
                                <div class="row">
...
<li class="breadcrumb-item"><a href="kafedralar/">Kafedralar</a></li>
<li class="breadcrumb-item active">МТ</li></ol>',
    '[[getResources? &parents=`130` &limit=`0` &includeTVs=`1`  &tplFirst=`staff_cat_list_first` &tpl=`staff_cat_list` &sortby=`{"menuindex":"ASC"}`]]' => '',
    '[[$footer]]' => '<footer>
    <div class="container footer">
        <div class="row">
            <div class="col-md-5 copyright">
