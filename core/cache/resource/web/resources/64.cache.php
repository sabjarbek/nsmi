<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1629356274,
    'editedby' => 1,
    'editedon' => 1637038241,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1629355020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
<head>
    <title>Anjumanlar - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-ms-12 breadcrumb-bg">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb"><li class="breadcrumb-item"><a href="doktorantlarga/">Doktorantlarga</a></li>
<li class="breadcrumb-item active">Anjumanlar</li></ol>
                                </nav>
                            </div>
                        ...
                        <div class="first-news-list" id="pdopage" style="padding:0">
                            <h6>Anjumanlar</h6>
                           <!-- [[!pdoPage? &parents=`64` &ajaxMode=`default` &limit=`5`  &tpl=`conftpl` &sortby=`{"publishedon":"ASC","createdon":"DESC"}`]]-->
                                                    <div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>21/08/2021</span>
                                <a href="http://emc.ndki.uz">Yevrosiyo konchilik kongressi. O\'zbekiston yevrosiyo tog\' qazma sanoati markaziga aylanmoqda.</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="http://emc.ndki.uz"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>21/08/2021</span>
                                <a href="https://idz.ndki.uz">“Zarafshon viloyatini kompleks innovatsion rivojlantirish: yutuqlar, muammolar va istiqbollar” mavzusidagi xalqaro konferensiya</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="https://idz.ndki.uz"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
                        ...
                        <div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>21/08/2021</span>
                                <a href="https://nbu.uz">Zarafshon vohasini kompleks va innovatsion rivojlantirish: yutuqlar, muammolar va istiqbollar” xalqaro ilmiy va amaliy anjuman</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="https://nbu.uz"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
...
<header>
    ...
    '[[pdoCrumbs]]' => '<ol class="breadcrumb"><li class="breadcrumb-item"><a href="doktorantlarga/">Doktorantlarga</a></li>
<li class="breadcrumb-item active">Anjumanlar</li></ol>',
    '[[getResources? &parents=`64` &limit=`7` &includeTVs=`1`  &tpl=`conftpl` &sortby=`{"publishedon":"ASC","createdon":"DESC"}`]]' => '                        <div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>21/08/2021</span>
                                <a href="http://emc.ndki.uz">Yevrosiyo konchilik kongressi. O\'zbekiston yevrosiyo tog\' qazma sanoati markaziga aylanmoqda.</a>
                            </div>
...
<div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>27/11/1080</span>
                                <a href="[[+tv.tizir_link]]">“Zarafshon viloyatini kompleks innovatsion rivojlantirish: yutuqlar, muammolar va istiqbollar” mavzusidagi xalqaro konferensiya</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="[[+tv.tizir_link]]"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
...
<div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span>27/11/1080</span>
                                <a href="[[+tv.tizir_link]]">Zarafshon vohasini kompleks va innovatsion rivojlantirish: yutuqlar, muammolar va istiqbollar” xalqaro ilmiy va amaliy anjuman</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="[[+tv.tizir_link]]"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
