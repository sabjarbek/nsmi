...
<html lang="ru">
<head>
    <title>E\'lonlar - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">E\'lonlar</li></ol>
                                </nav>
                            </div>
                        ...
                        <div class="first-news-list" id="pdopage" style="padding:0">
                            <h6>E\'lonlar</h6>
                            [[!pdoPage? &parents=`27` &ajaxMode=`default` &limit=`3`  &tpl=`newstpl` &sortby=`{"publishedon":"ASC","createdon":"DESC"}`]]
