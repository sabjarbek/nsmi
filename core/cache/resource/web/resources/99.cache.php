<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'TALABA HAFTASIGA QANCHA SOAT DARSDAN TASHQARI SHUG‘ULLANISHI KERAK?',
    'longtitle' => 'E\'lon namuna uzunroq zagalovok 1',
    'description' => '',
    'alias' => 'elon-namuna-4',
    'alias_visible' => 1,
    'link_attributes' => '',
    ...
    'parent' => 27,
    'isfolder' => 0,
    'introtext' => 'G‘arbning yetuk universitetlaridagi konsensus fikr shundan iboratki, o‘quv darsining har bir soati uchun talaba o‘rtacha 2 soat tayyorgarlik ko\'rishi kerak (“preparing for class”). Ya’ni, 1 para uchun talaba taxminan 3 soat qo‘shimcha vaqt sarflashi kerak. ',
    'content' => '<p style="box-sizing: border-box; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px; text-align: justify;"><strong style="box-sizing: border-box; margin: 0px; padding: 0px;">G‘arbning yetuk universitetlaridagi konsensus fikr shundan iboratki, o‘quv darsining har bir soati uchun talaba o‘rtacha 2 soat tayyorgarlik ko\'rishi kerak (“preparing for class”). Ya’ni, 1 para uchun talaba taxminan 3 soat qo‘shimcha vaqt sarflashi kerak. </strong></p>
...
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"> </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"><img style="box-sizing: border-box; margin: 0px; padding: 0px; border: 0px; vertical-align: middle; max-width: 100%;" title="Image: images/news11.jpg" src="images/news11.jpg" alt="" /></p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px; text-align: justify;">Agar fan haftasiga 2 para o‘tilsa, unga tayyorgarlik ko‘rish uchun o‘rtacha 6 soat sarflash nazarda tutilgan. <br style="box-sizing: border-box; margin: 0px; padding: 0px;" /> <br style="box-sizing: border-box; margin: 0px; padding: 0px;" />Darsga tayyorgarlik deganda uy vazifasini bajarish, kitob o‘qish, konspektlarni ko\'rib chiqish, yozish, laboratoriya ishlarini bajarish, ma‘lumotlarni tahlil qilish, o‘rganilgan materiallarni takrorlash va boshqa akademik faoliyat turlari kiradi. </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px; text-align: justify;">G‘arb ekspertlarining ta’kidlashicha, eng kuchli, eng istiqbolli talabalar haftasiga o‘rtacha 50-60 (kuniga 7-8) soat o‘qishar ekan. </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px; text-align: justify;">Shuni unutmangki, sifat sondan ustun, lekin sifat son bilan keladi.</p>',
    'richtext' => 1,
    'template' => 2,
    'menuindex' => 0,
    'searchable' => 1,
...
<html lang="ru">
<head>
    <title>TALABA HAFTASIGA QANCHA SOAT DARSDAN TASHQARI SHUG‘ULLANISHI KERAK? - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">TALABA HAFTASIGA QANCHA SOAT DARSDAN TASHQARI SHUG‘ULLANISHI KERAK?</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>TALABA HAFTASIGA QANCHA SOAT DARSDAN TASHQARI SHUG‘ULLANISHI KERAK?</h1>
                                <p>
