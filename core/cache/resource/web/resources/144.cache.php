<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Eshmurodov Ziyodullo Oripovich',
    'longtitle' => '',
    'description' => '',
    'alias' => 'eshmurodov-ziyodullo-oripovich',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1636116395,
    'editedby' => 1,
    'editedon' => 1636123853,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1636116360,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'eshmurodov-ziyodullo-oripovich.html',
    'uri_override' => 0,
    ...
    array (
      0 => 'Manzil',
      1 => 'G\'laba shox ko\'chasi 27 A 201 xona',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'Qabul_vaqti',
      1 => 'Har kuni (8:00 dan 16:00 gacha)',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
...
<html lang="ru">
<head>
    <title>Eshmurodov Ziyodullo Oripovich - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item"><a href="ab/">AB</a></li>
<li class="breadcrumb-item active">Eshmurodov Ziyodullo Oripovich</li></ol>
                                </nav>
                            </div>
<div class="col-ms-12 detail-content">
                                <h1>Eshmurodov Ziyodullo Oripovich</h1>
                                <div class="row">
                                <div class="col-md-3">
                                    <div class="image-dekan">
                                        <img src="images/teacher6.jpg"  class="img-thumbnail" style="width: 100%">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-5">
                                    <ul class="dekan-contact">
                                        <li><i class="fas fa-phone-square-alt"></i> <a href="#">  +998906659733</a><br>
                                        <label>Telefon</label></li>
                                        <li><i class="fas fa-envelope"></i> <a href="#"> eshmurodov@nsmi.uz</a><br>
                                ...
                                <div class="col-md-12 dekan-tabs" id="tabs">
                                         <ul class="nav nav-tabs" id="myTab" role="tablist">
                                              <li class="nav-item" role="presentation">
                                                    <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Biografiya</button>
                                              </li>
                                              <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Nashrlar</button>
                                              </li>
                                              <li class="nav-item" role="presentation">
                                                    <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Loyihalar</button>
                                              </li>
                                         </ul>
                                        <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">fssdfasdf</div>
                                              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">fgaergafsdf</div>
                                              <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">asdfDawefawf</div>
                                        </div>
                                </div>
                            </div>
                        </div>
