...
<html lang="ru">
<head>
    <title>Dars jadvali - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">Dars jadvali</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>Dars jadvali</h1>
                                <p>
