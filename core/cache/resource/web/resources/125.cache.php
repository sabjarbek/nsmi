<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'AB',
    'longtitle' => 'Avtomatlashtirish va boshqaruv kafedrasi',
    'description' => '',
    'alias' => 'ab',
    'alias_visible' => 1,
    'link_attributes' => '',
    ...
    'isfolder' => 1,
    'introtext' => '',
    'content' => '<p>Dekanat aloqalari</p>
<ul class="dekan-contact">
<li><a href="#">+99895055559999</a><br /> <label>Telefon</label></li>
<li><a href="#">jumayev@nsmi.uz</a><br /> <label>E-pochta manzili</label></li>
<li>210100, Navoiy shahar, G\'laba shox ko\'chasi 27 A 201 xona<br /> <label>Manzil</label></li>
</ul>',
    'richtext' => 1,
    'template' => 10,
    'menuindex' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1630582208,
    'editedby' => 1,
    'editedon' => 1636125164,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1630582200,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
<head>
    <title>AB - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<section>
    <div class="container">
       ...
       <div class="col-md-2 sidebar">
                ...
                <div class="left-menu">
                <ul class=""><li class="first"><a href="/" >Asosiy</a></li><li class="active"><a href="tuzilma/" >Tuzilma</a><ul class=""><li class="first active"><a href="kafedralar/" >Kafedralar</a><ul class=""><li class="first active"><a href="ab/" >AB</a></li><li><a href="mt.html" >МТ</a></li><li><a href="ki.html" >KI</a></li><li><a href="kt.html" >KT</a></li><li><a href="ee/" >EE</a></li><li><a href="nrm/" >NRM</a></li><li><a href="kem/" >KEM</a></li><li class="last"><a href="abp/" >AB</a></li></ul></li><li><a href="fakultetlar/" >Fakultetlar</a><ul class=""><li class="first"><a href="energo-mexanika-fakulteti.html" >Energo-mexanika fakulteti</a></li><li><a href="konchilik-fakulteti.html" >Konchilik fakulteti</a></li><li class="last"><a href="kimyo-metallurgiya-fakulteti.html" >Kimyo-metallurgiya fakulteti</a></li></ul></li><li><a href="tehnikumlar.html" >Texnikumlar</a></li><li><a href="litsey.html" >Litsey</a></li><li class="last"><a href="tehnopark.html" >Texnopark</a></li></ul></li><li><a href="talim.html" >Ta\'lim</a></li><li><a href="ilm-fan-va-innovatsiya/" >Ilm fan va innovatsiya</a></li><li><a href="talabalar-hayoti.html" >Talabalar hayoti</a></li><li><a href="talabaga-yordam.html" >Talabaga yordam</a></li><li class="last"><a href="xalqaro-aloqalar.html" >Xalqaro aloqalar</a></li></ul>
            </div>
...
<li class="breadcrumb-item"><a href="kafedralar/">Kafedralar</a></li>
<li class="breadcrumb-item active">AB</li></ol>
                                </nav>
                            </div>
<div class="col-ms-12 detail-content">
    <h1>Avtomatlashtirish va boshqaruv kafedrasi</h1>
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <img src="images/teacher6.jpg" class="rounded-circle shadow" style="width: 100%">
                                                    </div>
                                                    <div class="col-md-8 dekan-list-first">
                                                        <h1><a href="https://nsmi.uz/eshmurodov-ziyodullo-oripovich.html">Eshmurodov Ziyodullo Oripovich</a></h1>
                                                        <hr/>
                                                        <ul class="dekan-contact">
                                                            <li><i class="fas fa-phone-square-alt"></i> <a href="#"> +998906659733</a></li>
                                                            <li><i class="fas fa-envelope"></i> <a href="#">eshmurodov@nsmi.uz</a></li>
...
<li>210100, Navoiy shahar, G\'laba shox ko\'chasi 27 A 201 xona<br /> <label>Manzil</label></li>
                                    ...
                                    <div class="col-md-6 dekan-items">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <img src="assets/images/teacher8.jpg" class="rounded-circle shadow" style="width: 100%">
                                            </div>
                                            <div class="col-md-9">
                                                <h3><a href="https://nsmi.uz/jumaev-odil-abdujalilovich.html">Jumaev Odil Abdujalilovich</a></h3>
                                                <hr/>
                                                <ul>
                                                    <li>Professor</li>
                                    ...
                                    <div class="col-md-6 dekan-items">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <img src="images/teacher7.jpg" class="rounded-circle shadow" style="width: 100%">
                                            </div>
                                            <div class="col-md-9">
                                                <h3><a href="https://nsmi.uz/boyeva-oqila.html">Boyeva Oqila Husanovna</a></h3>
                                                <hr/>
                                                <ul>
                                                    <li>Asistent</li>
                                                    <li><i class="fas fa-phone-square-alt"></i> <a href="#">+998936638424</a></li>
                                                    <li><i class="fas fa-envelope"></i> <a href="#">boyeva@nsmi.uz</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 dekan-items">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <img src="images/teacher1.jpg" class="rounded-circle shadow" style="width: 100%">
                                            </div>
                                            <div class="col-md-9">
                                                <h3><a href="https://nsmi.uz/boboyev-aziz-azimjonovich.html">Boboyev Aziz Azimjonovich</a></h3>
                                                <hr/>
                                                <ul>
                                                    <li>Professor</li>
                                                    <li><i class="fas fa-phone-square-alt"></i> <a href="#">+998934326857</a></li>
                                                    <li><i class="fas fa-envelope"></i> <a href="#">boboyev@nsmi.uz</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
...
<li class="breadcrumb-item"><a href="kafedralar/">Kafedralar</a></li>
<li class="breadcrumb-item active">AB</li></ol>',
    '[[getResources? &parents=`125` &limit=`0` &includeTVs=`1`  &tplFirst=`staff_cat_list_first` &tpl=`staff_cat_list` &sortby=`{"menuindex":"ASC"}`]]' => '                                  <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p>Kafedra mudiri</p>
                                                <div class="row">
