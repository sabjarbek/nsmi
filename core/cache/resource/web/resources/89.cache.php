<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Shavkat Mirziyoyev: «Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi»',
    'longtitle' => 'Shavkat Mirziyoyev: «Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi»',
    'description' => '',
    'alias' => 'pandemiya-qachon-tugaydi',
    'alias_visible' => 0,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="single-header" style="box-sizing: border-box; outline: none; padding: 0px 20px 20px; position: relative; font-family: Montserrat; font-size: 16px; font-weight: 300;">
<div class="single-header__title" style="box-sizing: border-box; outline: none; font-size: 26px; font-weight: bold; line-height: 32px;">
<div class="single-header" style="box-sizing: border-box; outline: none; padding: 0px 20px 20px; position: relative; font-size: 16px; font-weight: 300;">
<div class="single-header__title" style="box-sizing: border-box; outline: none; font-size: 26px; font-weight: bold; line-height: 32px;"> </div>
</div>
<div class="single-content" style="box-sizing: border-box; outline: none; font-size: 19px; line-height: 31px; padding: 0px 20px 20px; border-left: 1px solid rgba(151, 151, 151, 0.23); margin-bottom: 20px; position: relative; font-family: PTSerif; font-weight: 300;">
<div class="main-img" style="box-sizing: border-box; outline: none; width: 787px; margin-bottom: 10px;"><img style="box-sizing: border-box; outline: none; border: 0px; max-width: 100%; height: auto; margin: auto; display: block; width: 787px;" src="https://storage.kun.uz/source/7/RdWGS7-HIaztorD_W1xno2jzVaSvCdLO.jpg" alt="" />
<div class="main-img__caption" style="box-sizing: border-box; outline: none; opacity: 0.56; color: #222222; font-family: Montserrat; font-size: 12px; line-height: 16px; letter-spacing: -0.06px; padding-bottom: 10px; padding-top: 10px;">Foto: Prezident matbuot xizmati</div>
</div>
<p style="box-sizing: border-box; outline: none;">Senat binosida saylangan prezident Shavkat Mirziyoyevning inauguratsiya marosimi bo‘lib o‘tmoqda. Kun.uz muxbiri xabariga ko‘ra, Shavkat Mirziyoyev tadbir davomida pandemiya haqida gapirdi.</p>
<p style="box-sizing: border-box; outline: none;">“Barchamiz ko‘rib-bilib turibmiz: bugungi kunda insoniyat o‘z tarixidagi nihoyatda murakkab davrni boshidan kechirmoqda. Biz ilgari ko‘rmagan, bilmagan mislsiz xavf-xatar va tahdidlarga duch kelmoqdamiz.</p>
<p style="box-sizing: border-box; outline: none;">Yer yuzida millionlab odamlarni hayotdan olib ketgan koronavirus pandemiyasi va uning oqibatida kelib chiqqan global iqtisodiy inqiroz hanuz davom etmoqda. Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi. </p>
<p style="box-sizing: border-box; outline: none;">Afsuski, pandemiyaning salbiy ta\'siridan O‘zbekiston ham chetda qolayotgani yo‘q. Bu xatarli kasallikka qarshi kurash, shunday og‘ir sharoitda yashash va mehnat qilish bizdan katta kuch va mablag‘, yuksak iroda va qat\'iy intizomni talab etmoqda.</p>
<p style="box-sizing: border-box; outline: none;">Har qancha harakat qilishimizga qaramasdan, pandemiya tufayli ko‘plab yurtdoshlarimiz, jumladan, bir qancha senator va deputatlarimiz, rahbar safdoshlarimizdan judo bo‘ldik. Bugun ularni barchasining xotirasini yana bir bor yod etib, oxiratlari obod bo‘lsin, deymiz.</p>
<p style="box-sizing: border-box; outline: none;">Hozirgi vaqtda dunyoda turli kuchlar o‘rtasida qarama-qarshilik va ziddiyatlar kuchaymoqda, resurslar uchun shafqatsiz kurash ketmoqda. Mintaqamizdagi tinchlik va xavfsizlikka nisbatan yangi-yangi tahdidlar paydo bo‘lmoqda.</p>
<p style="box-sizing: border-box; outline: none;">O‘z-o‘zidan ravshanki, globallashuv va keskin raqobat zamoni, shiddat bilan o‘zgarayotgan hayot bizning oldimizga kechiktirib bo‘lmaydigan, o‘ta muhim va dolzarb vazifalarni qo‘ymoqda. </p>
<p style="box-sizing: border-box; outline: none;">Mana shunday murakkab va qaltis vaziyatda barchamiz tinch va osoyishta hayotimizni asrash, milliy mustaqilligimizni mustahkamlash uchun, yanada jipslashib, hushyor va ogoh bo‘lib, dadil va qat\'iy harakat qilishimiz zarur. </p>
<p style="box-sizing: border-box; outline: none;">Shu maqsadda, har bir xonadon va mahallada, butun yurtimizda tinchlik va barqarorlikni saqlash, aholining hayot darajasi va sifatini oshirish, jahon hamjamiyati bilan do‘stlik va hamkorlikni kengaytirishga qaratilgan strategik yo‘limizni yanada izchil davom ettiramiz”, dedi Shavkat Mirziyoyev.</p>
</div>
</div>
</div>',
    'richtext' => 1,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'pandemiya-qachon-tugaydi.html',
    'uri_override' => 0,
...
<html lang="ru">
<head>
    <title>Shavkat Mirziyoyev: «Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi» - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">Shavkat Mirziyoyev: «Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi»</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>Shavkat Mirziyoyev: «Pandemiya qachon tugaydi va undan keyingi hayot qanday bo‘ladi – buni hech kim oldindan bashorat qilolmaydi»</h1>
                                <p>
                                   <!--<img class="detail-photo" src=""> -->
                                    <div class="single-header" style="box-sizing: border-box; outline: none; padding: 0px 20px 20px; position: relative; font-family: Montserrat; font-size: 16px; font-weight: 300;">
<div class="single-header__title" style="box-sizing: border-box; outline: none; font-size: 26px; font-weight: bold; line-height: 32px;">
<div class="single-header" style="box-sizing: border-box; outline: none; padding: 0px 20px 20px; position: relative; font-size: 16px; font-weight: 300;">
<div class="single-header__title" style="box-sizing: border-box; outline: none; font-size: 26px; font-weight: bold; line-height: 32px;"> </div>
</div>
