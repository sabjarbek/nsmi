<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1629784950,
    'editedby' => 1,
    'editedon' => 1629785484,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1629784920,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
<head>
    <title>tizers - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-ms-12 breadcrumb-bg">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb"><li class="breadcrumb-item"><a href="kontent/">Kontent</a></li>
<li class="breadcrumb-item active">tizers</li></ol>
                                </nav>
                            </div>
                        ...
                        <div class="first-news-list" id="pdopage" style="padding:0">
                            <h6>tizers</h6>
                            [[!pdoPage? &parents=`114` &ajaxMode=`default` &limit=`3`  &tpl=`newstpl` &sortby=`{"publishedon":"ASC","createdon":"DESC"}`]]
...
<header>
    ...
    '[[pdoCrumbs]]' => '<ol class="breadcrumb"><li class="breadcrumb-item"><a href="kontent/">Kontent</a></li>
<li class="breadcrumb-item active">tizers</li></ol>',
    '[[$footer]]' => '<footer>
    <div class="container footer">
        <div class="row">
...
<div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span></span>
                                <a href="https://nsmi.uz/uchinchi-tizer.html">O\'zbekiston Respublikasi Konstitutsiyasi</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="https://nsmi.uz/uchinchi-tizer.html"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
<div class="first-news-list-item">
                            <div class="first-news-list-item-title">
                                <span></span>
                                <a href="https://nsmi.uz/ikkinchi-tizer.html">Ziyonet</a>
                            </div>
                            <div class="first-news-list-item-desc">
                                <a href="https://nsmi.uz/ikkinchi-tizer.html"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>',
  ),
