<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Sayt yangiliklari',
    'longtitle' => '',
    'description' => '',
    'alias' => 'sayt-yangiliklari',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
...
<html lang="ru">
<head>
    <title>Sayt yangiliklari - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">Sayt yangiliklari</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                

                        <div class="first-news-list" id="pdopage" style="padding:0">
                            <h6>Sayt yangiliklari</h6>
                            [[!pdoPage? &parents=`84` &ajaxMode=`default` &limit=`3`  &tpl=`newstpl` &sortby=`{"publishedon":"ASC","createdon":"DESC"}`]]
...
`&toPlaceholder=``&parents=`84`&includeContent=``&includeTVs=``&prepareTVs=`1`&processTVs=``&tvPrefix=`tv.`&tvFilters=``&tvFiltersAndDelimiter=`,`&tvFiltersOrDelimiter=`||`&where=``&showUnpublished=``&showDeleted=``&showHidden=`1`&hideContainers=``&context=``&idx=``&first=``&last=``&tplFirst=``&tplLast=``&tplOdd=``&tplWrapper=``&wrapIfEmpty=``&totalVar=`page.total`&resources=``&tplCondition=``&tplOperator=`==`&conditionalTpls=``&select=``&toSeparatePlaceholders=``&loadModels=``&scheme=``&useWeblinkUrl=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&pageLimit=`5`&element=`pdoResources`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul>`&tplPageActive=`@INLINE <li class="page-item active"><a class="page-link" href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="page-item"><a class="page-link" href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">...</a></li>`&tplPageFirstEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_first]]</a></li>`&tplPageLastEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">[[%pdopage_last]]</a></li>`&tplPagePrevEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&laquo;</a></li>`&tplPageNextEmpty=`@INLINE <li class="page-item disabled"><a class="page-link" href="#">&raquo;</a></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=`1`&ajaxMode=`default`&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-primary btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`95d95e5558ee0ab06ae4261259e7f3fe`&setTotal=`1`]]' => '<div class="first-news-list-item">
                            ...
                            <div class="first-news-list-item-desc">
                                <a href="https://nsmi.uz/ozbek-tilining-milliy-korpusi.html"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
<div class="first-news-list-item">
                            ...
                            <div class="first-news-list-item-desc">
                                <a href="https://nsmi.uz/76-sessiyasidagi-nutqi.html"><img src="[[+tv.imageanons]]"></a>
                                <p></p>
                            </div>
                        </div>
<div class="first-news-list-item">
                            ...
                            <div class="first-news-list-item-desc">
                                <a href="https://nsmi.uz/facebook-nomini-ozgartirdi.html"><img src="[[+tv.imageanons]]"></a>
                                <p>Facebook kompaniyasi Meta’ga rebrending qildi. Kompaniyaning ijtimoiy tarmoqlari nomi o‘zgarmaydi.</p>
                            </div>
                        </div>',
  ),
  'sourceCache' => 
