<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Boyeva Oqila Husanovna',
    'longtitle' => '',
    'description' => '',
    'alias' => 'boyeva-oqila',
    'alias_visible' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1636117892,
    'editedby' => 1,
    'editedon' => 1636118103,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1636117980,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<html lang="ru">
<head>
    <title>Boyeva Oqila Husanovna - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">Boyeva Oqila Husanovna</li></ol>
                                </nav>
                            </div>
<div class="col-ms-12 detail-content">
                                <h1>Boyeva Oqila Husanovna</h1>
                                <div class="row">
                                <div class="col-md-3">
                                    <div class="image-dekan">
                                        <img src="images/teacher7.jpg"  class="img-thumbnail" style="width: 100%">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-5">
                                    <ul class="dekan-contact">
                                        <li><i class="fas fa-phone-square-alt"></i> <a href="#"> +998936638424</a><br>
                                        <label>Telefon</label></li>
                                        <li><i class="fas fa-envelope"></i> <a href="#"> boyeva@nsmi.uz</a><br>
                                ...
                                <div class="col-md-12 dekan-tabs" id="tabs">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">boyeva</div>
                                              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">asdfasdfasdf</div>
                                              <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">asdasdf</div>
                                        </div>
                                </div>
                            </div>
                        </div>
