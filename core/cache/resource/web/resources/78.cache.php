<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'XALQARO HAMKORLIKNING YANGI BOSQICHI',
    'longtitle' => '',
    'description' => '',
    'alias' => 'xalqaro-hamkorlik',
    'alias_visible' => 1,
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'parent' => 26,
    'isfolder' => 0,
    'introtext' => 'Navoiy davlat konchilik instituti Nukus filiali Hindiston Respublikasining Karnataka Surathkal milliy texnologiya instituti bilan hamkorlik shartnomasi imzolandi.',
    'content' => '<p style="box-sizing: border-box; margin-right: 0px; margin-bottom: 10px; margin-left: 0px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"><strong style="box-sizing: border-box; margin: 0px; padding: 0px;"><span style="box-sizing: border-box; margin: 0px; padding: 0px; color: #666666; font-family: poppins;">Navoiy davlat konchilik instituti Nukus filiali Hindiston Respublikasining Karnataka Surathkal milliy texnologiya instituti bilan hamkorlik shartnomasi imzolandi.</span></strong></p>
...
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"> </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;">Onlayn uchrashuvda Karnataka Surathkal milliy texnologiya instituti rektori Karanam Umamaheshwar Rao va Navoiy davlat konchilik instituti Nukus filiali direktori Atabek Kaipbergenov ikki oliy ta’lim muassasalari o’rtasidagi o’zaro hamkorlikning ahamiyatlari xususida to’xtalib o’tishdi.</p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;">Hamkorlikning asosiy maqsadi – Hindiston va O‘zbekiston Respublikalari oliy o‘quv yurtlari o‘rtasida  ta’lim va fan sohasidagi hamkorlikni rivojlantirish, yuqori malakali mutaxassislarni tayyorlash, soha mutaxassislarining malakasini muntazam takomillashtirish, texnik ta’lim va fan sohasidagi hamkorlikni rivojlantirish, ma’ruzalar o’qish, seminar va ilmiy maslahatlashuvlarni birgalikda o’tkazish, nufuzli xalqaro jurnallarda tadqiqot natijalarini e’lon qilishda o’zaro hamkorlikdan iborat.</p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;">Shartnoma doirasida zamonaviy o‘qitish uslublari va tizimlaridan foydalanish va ta’lim sohasida innovatsion texnologiyalarni qo‘llash, o‘quv rejalari va dasturlarini takomillashtirish, tajriba almashish, o‘qituvchilar, xodimlar, doktorantlar va magistrantlar uchun qisqa muddatli ilmiy va o‘quv amaliyotlari va malaka oshirishni tashkil yetish, ilmiy anjumanlar va ilmiy seminarlar va boshqa tadbirlar to‘g‘risida ma’lumot almashish kabi bir qator vazifalar belgilab olingan.</p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"> </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"> </p>
<p style="box-sizing: border-box; margin: 0px 0px 10px; padding: 0px; font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; font-size: 14px;"><span class="smallText spaceBorder" style="box-sizing: border-box; margin: 0px; padding: 0px;">Manba: <a style="box-sizing: border-box; margin: 0px; padding: 0px; background-color: transparent; color: #337ab7; text-decoration-line: none;" href="http://ndkinf.uz/" target="_blank">http://ndkinf.uz/</a></span></p>',
    'richtext' => 1,
    'template' => 4,
    'menuindex' => 0,
    'searchable' => 1,
...
<html lang="ru">
<head>
    <title>XALQARO HAMKORLIKNING YANGI BOSQICHI - Navoiy Davlat Konchilik Instituti</title>
    <base href="[[!++site_url]]" />
    <meta charset="UTF-8" />
...
<li class="breadcrumb-item active">XALQARO HAMKORLIKNING YANGI BOSQICHI</li></ol>
                                </nav>
                            </div>
                            <div class="col-ms-12 detail-content">
                                <span></span><h1>XALQARO HAMKORLIKNING YANGI BOSQICHI</h1>
                                <p>
                                   <!--<img class="detail-photo" src="images/xamkorlik.jpg"> -->
